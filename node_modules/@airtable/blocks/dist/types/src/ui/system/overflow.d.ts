...
export declare const overflow: import("@styled-system/core").styleFn;
export declare const overflowPropTypes: import("../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
