...
function (_AbstractModelWithAsy) {
  ...
  /** @internal */
  function Cursor(sdk) {
    var _ref, _baseData$cursorData, _ref2, _baseData$cursorData2, _ref3;

    var _this;

    (0, _classCallCheck2.default)(this, Cursor);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Cursor).call(this, sdk, 'cursor'));
    ...
    var activeViewId = (_ref3 = activeTable === null || activeTable === void 0 ? void 0 : activeTable.activeViewId) !== null && _ref3 !== void 0 ? _ref3 : null;
    _this._cursorData = {
      selectedRecordIdSet,
      selectedFieldIdSet,
      activeTableId,
      ...
      return _regenerator.default.async(function _loadDataAsync$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _regenerator.default.awrap(this._sdk.__airtableInterface.fetchAndSubscribeToCursorDataAsync());
