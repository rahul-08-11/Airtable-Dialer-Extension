...
var ViewPickerSynced = (props, ref) => {
  var globalConfigKey = props.globalConfigKey,
      ...
      restOfProps = (0, _objectWithoutProperties2.default)(props, ["globalConfigKey", "table", "onChange", "disabled"]);
  ...
  return React.createElement(_view_picker.default, (0, _extends2.default)({}, restOfProps, {
    ref: ref,
    table: table,
...
var ForwardedRefViewPickerSynced = React.forwardRef(ViewPickerSynced);
...
var _default = ForwardedRefViewPickerSynced;
